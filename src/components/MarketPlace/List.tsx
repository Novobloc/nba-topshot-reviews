...
import Logo1 from "../../assets/nba2.png";
import Logo2 from "../../assets/nba3.png";
import Logo3 from "../../assets/nba4.png";
import Logo4 from "../../assets/nba5.png";
            ...
            <div className="mx-auto flex max-w-7xl space-x-6 divide-x divide-gray-200 px-4 text-sm sm:px-6 lg:px-8">
              <div>
                <Disclosure.Button className="group flex items-center font-medium text-gray-700">
                  <FunnelIcon className="mr-2 h-5 w-5 flex-none text-gray-400 group-hover:text-gray-500" aria-hidden="true" />2 Filters
                </Disclosure.Button>
              </div>
              <div className="pl-6">
